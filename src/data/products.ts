...
export const PRODUCTS: Product[] = [
  ...
  { 
    ...
    price: 0,
    unit: 'crate', 
    description: 'Fresh, farm-raised eggs.', 
    image: '/eggs.png', 
    variants: [ 
      { id: 'eggs-small', name: 'Small', price: 55 },
      { id: 'eggs-medium', name: 'Medium', price: 60 },
      { id: 'eggs-large', name: 'Large', price: 70 },
    ] 
  }, 
  
  // == FISH & SEAFOOD ==
  { id: 'tilapia', name: 'Tilapia', category: 'fish', price: 230, unit: '3 Large pieces', description: 'Fresh tilapia.', image: '/tilapia.png' },
  { id: 'catfish', name: 'Catfish', category: 'fish', price: 55, description: 'Fresh catfish.', image: '/catfishp.png' },
  { id: 'mackerel', name: 'Mackerel', category: 'fish', price: 600, unit: 'Box', description: 'Fresh mackerel.', image: '/mackerel.png' },
  { id: 'grouper', name: 'Grouper', category: 'fish', price: 165, unit: '1 kg', description: 'Fresh grouper.', image: '/grouper.png' },
  { id: 'crabs', name: 'Crabs', category: 'fish', price: 40, unit: '4 Large pieces', description: 'Fresh crabs.', image: '/crabs.png' },
  { id: 'shrimp', name: 'Shrimp', category: 'fish', price: 140, unit: '1 kg', description: 'Fresh shrimp.', image: '/shrimp.png' },
  { id: 'octopus', name: 'Octopus', category: 'fish', price: 200, unit: '1 kg', description: 'Fresh octopus.', image: '/octopus.png' },
  { id: 'squid', name: 'Squid', category: 'fish', price: 200, unit: '1 kg', description: 'Fresh squid.', image: '/squid.png' },
  
  // == VEGETABLES (Prices TBD) ==
  { id: 'tomatoes', name: 'Tomatoes', category: 'vegetables', price: 35, unit: '1 kg', description: 'Fresh, organic tomatoes.', image: '/tomatoes.png' },
  { id: 'onions', name: 'Onions', category: 'vegetables', price: 35, unit: '1 kg', description: 'Fresh, organic onions.', image: '/onions.png' },
  { id: 'chili-pepper', name: 'Chili Pepper (Dry)', category: 'vegetables', price: 35, unit: '1 kg', description: 'Fresh, hot chili pepper.', image: '/chili-pepper.png' },
  { id: 'bell-pepper', name: 'Bell Pepper (Green)', category: 'vegetables', price: 50, unit: '1 kg', description: 'Fresh, sweet bell pepper.', image: '/bell-pepper.png' },
  { id: 'okra', name: 'Okra', category: 'vegetables', price: 25, unit: '1 kg', description: 'Fresh, organic okra.', image: '/okra.png' },
  { id: 'garden-eggs', name: 'Garden Eggs', category: 'vegetables', price: 15, unit: '1 kg', description: 'Fresh, organic garden eggs.', image: '/garden-eggs.jpg' },
  { 
    id: 'cabbage', 
    name: 'Cabbage', 
    category: 'vegetables', 
    price: 0, 
    description: 'Fresh, organic cabbage. Select your preferred size.', 
    image: '/cabbage.png', 
    variants: [ 
      { id: 'cabbage-small', name: 'Cabbage - Small', price: 10 },
      { id: 'cabbage-medium', name: 'Cabbage - Medium', price: 15 },
      { id: 'cabbage-large', name: 'Cabbage - Large', price: 25 },
    ] 
  },
  { id: 'carrots', name: 'Carrots', category: 'vegetables', price: 37, unit: '1 kg', description: 'Fresh, organic carrots.', image: '/carrots.png' },
  { id: 'lettuce', name: 'Lettuce', category: 'vegetables', price: 35, unit: '1 kg', description: 'Fresh, organic lettuce.', image: '/lettuce.png' },
  { id: 'cucumber', name: 'Cucumber', category: 'vegetables', price: 30, unit: '1 kg', description: 'Fresh, organic cucumber.', image: '/cucumber.png' },
  { id: 'spinach', name: 'Spinach', category: 'vegetables', price: 35, unit: '1 kg', description: 'Fresh, organic spinach.', image: '/spinach.png' },
];